...
7. After the page loads upload your book which you would like to read.
8. You can click on the book link to check after uploading.
9. In Nintendo Switch you can access the browser using https://www.switchbru.com/dns/
10. Now goto your local IP and mention the url with port number and you are done!!
11. You can view the books on clicking the name.
